...
import { ConfigService, getCSSFontFamily, getWindows10Build, HostAppService, HotkeysService, NotificationsService, Platform, PlatformService, ThemesService, TranslateService } from 'aterm-core'
...
export class XTermFrontend extends Frontend {
    ...
    private configureColors (scheme: TerminalColorScheme | null): void {
        ...
        const theme: ITheme = {
            ...
            background: getTerminalBackgroundColor(this.configService, this.themes, scheme) ?? scheme.background ?? '#00000000',
