...
import { BaseComponent, ConfigService, PromptModalComponent, HostAppService, PlatformService, NotificationsService, TranslateService } from 'aterm-core'
...
@Component({
    ...
    templateUrl: './configSyncSettingsTab.component.html',
})
